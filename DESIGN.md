...
| --layout-reel-card-min | clamp(15rem, 24vw, 20rem) | Desktop sponsor brand card width for the sticky footer reel. |
...
- **Logo treatment**: real sponsor image assets fill compact glass cards; light-background logo files sit on solid white cards that match the logo image background while the carousel shelf stays transparent and the rail height stays fixed.
